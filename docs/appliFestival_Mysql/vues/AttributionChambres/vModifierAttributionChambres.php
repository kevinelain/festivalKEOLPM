...
?>
	...
	<table width="90%" cellspacing="0" cellpadding="0" class="tabQuadrille">
		...
		<tr class="enTeteTabQuad">
			<td  colspan="<?php echo $nbCol ; ?>"><strong>
				Effectuer ou modifier les attributions</strong>
			</td>
		</tr>
...
?>
						<td class="absenceOffre"><?php echo $idTypeChambre ; ?><br/>&nbsp;</td>
<?php					
					}
					else
					{
					   ...
					   {
						  echo "<td class='reserveSiLien'>$idTypeChambre<br/>&nbsp; </td>";
					   }
					}
...
?>
		...
		<tr class="ligneTabQuad">
			<td align="center" width="25%"><?php echo $nom ; ?></td>
<?php
				$req = obtenirReqIdEtablissementsOffrantChambres();
				$rstEtab = mysql_query($req,$oCnx);
...
<?php
						...
						else
						{
							...
							$nbOccupGroupe = obtenirNbOccupGroupe($idEtab, $idTypeChambre, $idGroupe);
							if ($nbOccupGroupe != 0)
							{
...
?>
	...
	<br/><center><a href="cAttributionChambres.php">Retour</a></center>
<?php
