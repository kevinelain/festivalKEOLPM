...
public class JPanelOffHeber extends javax.swing.JPanel {
    ...
    private void chargerListeEtablissement(){
        ...
        while (etab.hasNext()){
           ...
           jCbOffHeber.addItem(unEtablissement.getNom());
           }
        ...
        */
        ...
        System.out.println(unEtalissement2.getId() + "    " + unEtalissement2.getNom());
    ...
    public void chargerTabEtab(Etablissement pEtab){
        ...
        */
        ...
        String sQuery2 = "from Offre where idEtab ";
        ...
        while (typecha.hasNext()){
            ...
            {unTypeCh.getId(), unTypeCh.getLibelle()});
           }
